...
public class FakeStoreProductService implements ProductService {
    ...
    public List<Product> getAllProducts() {
        ...
        //in above line we can not use List.class as it is not a concrete class. ALso we can not use List<>.class as generics
        //are not available at runtime. So we use array of FakeStoreProductDto and then convert it to List<Product>.
